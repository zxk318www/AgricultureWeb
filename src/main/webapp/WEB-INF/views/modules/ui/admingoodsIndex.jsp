    ...
    <div class="sz_contentbox">
        <div class="sz_bigbox">
            <div class="left_box">
                ...
                <h2 style="color: #0B61A4;text-align: center;margin-top: 50px">用户商品信息管理模块</h2>
                <div style="padding:20px 50px 20px 50px;">
                    <div style="background:#FAFAFA;padding:10px 20px 10px 20px;line-height:24px;">
                        ...
                        <div id="datagrid1" class="mini-datagrid" style="height:320px;"
                             url="${path}/Goodscheck/findAllGoodsPage"  idField="id" allowResize="true">
...
<div id="editWindow" class="mini-window" title="商品编辑操作" style="width:500px;"
     showModal="true" allowResize="true" allowDrag="true">
    <div id="editform" class="form" >
        <input class="mini-hidden" name="id"/>
        <table style="width:100%;">
            <tr>
                <span style="color: #0B61A4;">您正在对商品进行操作。。。</span>
            </tr>
            ...
            <tr>
                <td style="text-align:right;padding-top:5px;padding-right:20px;" colspan="6">
                    <a class="Update_Button" href="javascript:updateGoods()">确定</a>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        var jsonDatas = [{'typeId':'1','typeValue':'下架'},{'typeId':'2','typeValue':'驳回'},{'typeId':'3','typeValue':'删除'},{'typeId':'4','typeValue':'上架'}];

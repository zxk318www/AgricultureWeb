            ...
            <div class="left_box">
                ...
                <div style="padding:20px 50px 20px 50px;">
                    <div style="background:#FAFAFA;padding:10px 20px 10px 20px;line-height:24px;">
                       <div id="msg1">
                        <span class="f_gray">请输入当前用户密码，密码正确后，方可对信息做修改！</span>
                       </div>
                        <div id="msg2">
                            <span class="f_gray">请认真、仔细地填写以下信息，修改用户，只能对个人基本信息进行修改操作，请知悉！<span class="f_red">*</span>为必填项</span>
                        </div>
                    </div>
                    <br>
                    <form >
                    ...
                    <form  id="update-form"  >
                        ...
                        <table cellpadding="5" cellspacing="5" width="100%">
                            ...
                            <tr>
                                <td class="tl">用户类型 </td>
                                <td>
                                    <input  class="mini-textbox" style="width:200px;"  id="state" enabled="false" <c:if test="${userinfo.level eq 5 }">value="会员用户"</c:if>  <c:if test="${userinfo.level eq 1}">value="普通用户"</c:if>>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        <table cellpadding="5" cellspacing="5" width="100%">
                            ...
                            <td width="220"><input type="text" class="mini-textbox" style="width:200px;" name="username" id="username"  value="${user}" required="true" requiredErrorText="登录名不能为空"  >
                            </td>
                            </tr>
                            <td class="tl">登录密码 <span class="f_red">*</span></td>
                            <td><input type="password" class="mini-password" style="width:200px;" name="password" id="password"  onvalidation="check" value="${pwd}"
                        ...
                        <table cellpadding="5" cellspacing="5" width="100%">
                            ...
                            <td width="220">
                                <input type="text" class="mini-textbox" style="width:100px;" name="name" id="name"  value="${userinfo.name}" required="true" requiredErrorText="真实姓名不能为空">
                                <input type="radio" name="sex" value="1" <c:if test="${userinfo.sex eq '男'}">checked=""</c:if> id="gender_1"><label for="gender_1"> 先生</label>
                                <input type="radio" name="sex" value="2" <c:if test="${userinfo.sex eq '女'}">checked=""</c:if>  id="gender_2"><label for="gender_2"> 女士</label>
                                </tr>
                            </td>
                            <td class="tl">证件号码 <span class="f_red">*</span></td>
                            <td><input type="text" class="mini-textbox" style="width:200px;" name="idCard" id="idCard"  value="${userinfo.idCard}" required="true" requiredErrorText="证件号码不能为空" ></td>

                            </tr>
                            <td class="tl">年龄 </td>
                            <td><input type="text" class="mini-textbox" style="width:200px;" name="age" id="age" value="${userinfo.age}"  ></td>

                            </tr>


                            <td class="tl">手机号码 <span class="f_red">*</span></td>
                            <td><input type="text" class="mini-textbox" style="width:200px;" name="moblie" id="moblie" value="${userinfo.moblie}" required="true" requiredErrorText="手机号码不能为空" ></td>
                            <td>
                            ...
                            <td class="tl">座机号码 </td>
                            <td><input type="text" class="mini-textbox" style="width:200px;" name="phone" id="phone" value="${userinfo.phone}" ></td>

                            </tr>

                            <td class="tl">收件地址 <span class="f_red">*</span></td>
                            <td><input type="text" class="mini-textbox" style="width:200px;" name="address" id="address" value="${userinfo.address}" required="true" requiredErrorText="收件地址不能为空"></td>
                            <td>
...
<script type="text/javascript">
    ...
    function update(){
        ...
        var img = editor.html();
        $.ajax({
            url: "${path}/logincheck/updateUserinfo?&sex="+sex+"&localuser="+localuser,
            type: "post",

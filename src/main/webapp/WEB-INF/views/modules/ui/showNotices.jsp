        ...
        <div class="sz_bigbox">
            <div class="left_box">
                ...
                <div style="padding:20px 50px 20px 50px;height: auto">
                    <h1 style="margin-left: 32%;margin-top: 30px">查看【${order.id}】订单</h1>
                    ...
                    <div style="margin-top: 20px;border: 1px solid slategrey;padding: 10px;font-size: 18px;width: 100%" class="mini-panel"
                         showCollapseButton="true"  collapseOnTitleClick="true" title="物流信息">
                        <div style="background:#FAFAFA;padding:10px 2px 10px 2px;line-height:24px;">
                        ...
                        <div style="margin-left: 80px">
                            <tr><label ><b>物流名称：</b></label><span class="f_b f_orange" >${express.name}</span></tr><br>
                            <tr><label ><b>物流单号：</b></label><span class="f_b f_orange" >${express.kddh}</span></tr><br>
                            <tr> <label ><b>物流信息：</b></label><span class="f_b f_orange" >${express.msg}</span>&nbsp;&nbsp;

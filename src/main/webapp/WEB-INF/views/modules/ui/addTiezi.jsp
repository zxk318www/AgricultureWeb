    ...
    <div class="sz_contentbox">
        <div class="sz_bigbox">
            <div class="left_box">
                ...
                <!--标题 -->
                <h2 style="color: #0B61A4;text-align: center;margin-top: 50px">新增帖子</h2>
                <div style="padding:20px 50px 20px 50px;">
                    ...
                    <div style="margin-top: 20px;margin-bottom: 5px;"><span style="font-size: 18px">帖子标题：</span>
                        <input  id="title"  name="title" class="mini-textbox" required="true" style="width: 500px"/></div>

                    <div style="margin-top: 20px;"><span style="font-size: 18px">帖子正文：</span>
                        <textarea  name="article.content1" class="kindeditor" tools="basic" style="width:100%;height: 400px"></textarea></div>

                </div>

                <div style="text-align:center;padding:8px;">
                    <input id="bc" type="button" class="mini-button-success" value="发帖" onclick="save();"/>
...
<script charset="utf-8" type="text/javascript">
    ...
    function save() {
        ...
        $.ajax({
            ...
            data:{"content":text,"title":title,"uid":uid,"type":str},
            type: 'post',
            scriptCharset: 'utf-8',
            async:false,
